...
export const allVideoProjects: VideoProject[] = [
  ...
  },
  {
    ...
    publish_date: "2025-19-01",
    client_name: "Naimur Rahman",
    client_image: "/companies/client-logo.png",
    client_feedback: ".",
    video_link: "https://youtu.be//82k63GhPlpQ",
    project_images: ["/path/to/image1.jpg"],
    category: ["Shorts"],
    duration: "45 sec",
    software_used: ["Premiere Pro", "After Effects"],
  ...
  {
    id: " dt96aCW8Xkg",
    video_title: "মানুষ আপনার কথা শুনতে চায়",
    video_description: "The video is just text bassed editing",
    tags: ["Blog", "Shorts"],
    cover_image: "dt96aCW8Xkg",
    publish_date: "2025-12-14",
    client_name: "Naimur Rahman",
    client_image: "/companies/client-logo.png",
    client_feedback: ".",
    video_link: "https://youtu.be/dt96aCW8Xkg",
    project_images: ["/path/to/image1.jpg"],
    category: ["Shorts"],
    duration: "45 sec",
    software_used: ["Premiere Pro", "After Effects"],
  ...
  //   tags: ["Cyber Security", "Protection", "Ads"],
